            ...
            {loading ? (
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Booked on {new Date(myBooking.booking_date).toLocaleDateString()}
                      </p>
                      <p className="text-sm text-gray-600">
                        Status: <span className="text-green-600 font-medium">{myBooking.status}</span>
                      </p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">50 DKK</p>
              ...
              <div className="text-center py-8">
                <p className="text-gray-600">
                  No bookings yet. 
                  <a href="/" className="text-orange-600 hover:text-orange-700 ml-1">
                    Book your spot now!
                  </a>
                </p>
              </div>
